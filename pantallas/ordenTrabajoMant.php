					...
					<div class="row">
						<div class="col-xs-12 col-sm-12">
							...
							<div class="form-group col-xs-12 col-sm-6" id="lbltipotrab" name="lbltipotrab" tooltip="Get Down." flow="up">
								...
								<?php $objUtilidades->hacer_lista_desplegableMultiple($conexion,$tabla="tipotrabmant",$value="ttmID",$mostrar="descrip",$nombre="ttmID",$sql="select ttmID,descrip,indseg from tipotrabmant where usuarioIDdelete=0;",$funcion=""); ?>
								<span class="help-block"></span>
							</div>

							<div class="form-group col-xs-12 col-sm-3" style='display:none;'>
								<?php $objUtilidades->hacer_lista_desplegableMultiple($conexion,$tabla="tipotrabmant",$value="ttmID",$mostrar="indseg",$nombre="indseg",$sql="select ttmID,descrip,indseg from tipotrabmant where usuarioIDdelete=0;",$funcion=""); ?>
							</div>
