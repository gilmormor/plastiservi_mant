		...
		<div class="row">
			<div class="col-xs-12 col-sm-12">
				<div class="form-group col-xs-12 col-sm-4">
					<button type="button" id="btnAgregar" name="btnAgregar" class="btn btn-primary" title='Agregar Equipos fuera de servicio' data-placement="right" data-toggle="tooltip">Agregar</button>
				</div>
			</div>
		</div>
	</div>
	  ...
	  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h3 class="modal-title" id="exampleModalLongTitle" name="exampleModalLongTitle"></h3>
	      ...
	      <div class="modal-body">
				<form>
					<input type="hidden" name="fueraServicioIDM" id="fueraServicioIDM">
					<input type="hidden" name="filaST" id="filaST">
					<input type="hidden" name="usuarioIDM" id="usuarioIDM">
					<div class="row">
						<div class="col-xs-12 col-sm-12">
							<div class="form-group col-xs-12 col-sm-12">
								<label for="maquinariaequiposDetalleIDM" class="col-form-label">Equipo:</label>
								<?php $objUtilidades->hacer_lista_desplegableBusB41S($conexion,$tabla="maquinariaequiposdetalle",$value="maquinariaequiposDetalleID",$mostrar="descripcion",$nombre="maquinariaequiposDetalleIDM",$sql="select maquinariaequiposdetalle.*,
									concat(maquinariaequiposdetalle.codigoInterno,' - ', maquinariaequipos.descripcion) AS descripcion
									from maquinariaequiposdetalle INNER JOIN maquinariaequipos
									on maquinariaequiposdetalle.maquinariaEquiposID=maquinariaequipos.maquinariaEquiposID
									WHERE maquinariaequiposdetalle.maquinariaequiposDetalleID;",$funcion=""); ?>
						...
						<div class="col-xs-12 col-sm-12">
							<div class="form-group col-xs-12 col-sm-12">
								...
								<input class="form-control" id="descripcionM" name="descripcionM"></input>
								<span class="help-block"></span>
							</div>
						</div>
					</div>
...
-->
	...
	<script src="../javascript/maquinaequipofueraservicio.js" language="javascript" type="text/javascript"> </script>
