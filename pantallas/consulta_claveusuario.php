	...
	<form method="POST">
		...
		<div class="container">
			<div class="form-group separador-md">
				<div class="bg-primary text-center titulo text-uppercase">Clave Usuarios</div>
			</div>	
...
-->
	...
	<script src="../javascript/consulta_claveusuario.js" language="javascript" type="text/javascript"> </script>
	<!--
