	...
	<div class="container-fluid" >
		<div class="col-xs-12 col-md-12">
			...
			<div class="col-xs-12" id="">
				<p>
				Debe ingresar el número de depósito correspondiente. El monto total en efectivo debe ser mayor o igual a <b>Total a depositar</b>. Si <b>Total Depósitos</b> es menor al <b>Total a depositar</b> no podra entrar al Sistema. Debe Tomar en cuenta que si ud hace los depositos en cheque estos deben ser validados por el colegio. Verifique los montos.
				</p><br>
			</div>
		</div>
		<div class="col-xs-12 col-md-12">
			<div class="col-xs-12  col-md-5" id="vidtablaesther" name="vidtablaesther">
				<div class="col-xs-12">
					<table class="table table-striped table-bordered table-hover table-condensed" width="100%" id="tablaesther" name="tablaesther">
					</table>
				</div>
			</div>
		</div>
		...
		<div class="col-xs-12 col-md-4" id="divsoft">
			...
			-->
			 	<div class="col-xs-12">
			 		<button type="button" class="btn btn-primary col-xs-8 col-md-8 col-xs-offset-2 col-md-offset-2" id="btnsoft" name="btnsoft" title="Guardar Depósito Plataforma">Guardar Depósito</button>
			 	</div>
			</div>
		...
		<div class="col-xs-12 col-md-4" id="divcol">
			...
			-->
			 	<div class="form-group col-xs-12">
			 		<button type="button" class="btn btn-primary col-xs-8 col-md-8 col-xs-offset-2 col-md-offset-2" id="btncol" name="btncol" title="Guardar Depósito Colegio">Guardar Depósito</button>
			 	</div>
			</div>
		...
		<div class="form-group col-xs-12 col-md-4" id="divpad">
			...
			-->
			 	<div class="form-group col-xs-12">
			 		<button type="button" class="btn btn-primary col-xs-8 col-md-8 col-xs-offset-2 col-md-offset-2" id="btnpad" name="btnpad" title="Guardar Depósito Consejo de Padres">Guardar Depósito</button>
			 	</div>
			</div>
		</div>
		<div class="container">
	 	...
	 	<div class="form-group col-xs-12">
	 		<button type="button" class="btn btn-primary col-xs-12 col-md-12" id="btnsiguiente" name="btnpad" title="Entrar al Sistema">Siguiente</button>
	 	</div>
