	  ...
	  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
				<form>
					<input type="hidden" name="ttmIDM" id="ttmIDM">
					<input type="hidden" name="filaST" id="filaST">
					<input type="hidden" name="usuarioIDM" id="usuarioIDM">
					<div class="row">
						<div class="col-xs-12 col-sm-12">
							<div class="form-group col-xs-12 col-sm-12">
								<label for="descripM" class="col-form-label">Tipo de actividad:</label>
								<input class="form-control" id="descripM" name="descripM"></input>
								<span class="help-block"></span>
							</div>
						</div>
						<div class="col-xs-12 col-sm-12">
							<div class="form-group col-xs-12 col-sm-12">
								<label for="definicionM" class="col-form-label">Definición:</label>
								<textarea class="form-control" id="definicionM"></textarea>
								<span class="help-block"></span>
							</div>
						</div>
						<div class="col-xs-12 col-sm-12">
							<div class="form-group col-xs-12 col-sm-12">
								<label for="displegalM" class="col-form-label">Disposiciones legales:</label>
								<textarea class="form-control" id="displegalM"></textarea>
								<span class="help-block"></span>
							</div>
						</div>
						...
						<div class="col-xs-12 col-sm-12">
							<div class="form-group col-xs-12 col-sm-12">
								<label for="indsegM" class="col-form-label">Indicaciones de Seguridad:</label>
								<textarea class="form-control" id="indsegM"></textarea>
								<span class="help-block"></span>
							</div>
						</div>
					</div>
...
-->
	...
	<script src="../javascript/tipotrabmant.js" language="javascript" type="text/javascript"> </script>
