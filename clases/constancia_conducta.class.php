	...
	<div id='cuerpo'  style='width:740px; text-align:center;'>
		<div style='width:100%; text-align:center;'>
			...
			<p style='line-height: 2.1;  text-indent: 5em; text-align:justify;'> 
				...
				fecha de nacimiento <?php echo $dia_nacimeinto_nro ?> de <?php echo $mes_nacimiento_letra ?> de <?php echo $anno_nacimiento_nro ?>, 
				
				de <?php echo $edad ?> años de edad. Con cédula de identidad  <?php echo $letra ?>-<?php echo $cedula ?>,
			
				cursó en esta Institución en el <?php echo $semestre ?>° <?php echo $nivel ?> de <?php echo $plan_estudio ?>, durante el
				año escolar: <?php echo $lapso ?> 
				
				y durante su permanencia en el mismo se observó BUENA CONDUCTA.
...
$mPDF->Output("ConstanciaConducta.pdf",$aux_resplan); 
