...
<body>
	...
	<tr>
		<td width='30%'>
			<div id='logo' style='width:50%; text-align:center;'>
	...
	<div id='cuerpo'  style='width:740px; text-align:center;'>
		<div style='width:100%; text-align:center;'>
			<br>
			<h2> CONSTACIA DE INSCRIPCION </h2> 
			<br>
			<br>
			<p  style='line-height: 2.1;  text-indent: 5em; text-align:justify;' > 
				...
				Código de Plantel  <?php echo $nro_plantel ?>,
				por medio de la presente hace constar que:
			
				<strong><?php echo $nombre_estudiante ?>,</strong> 
			
				fecha de nacimiento <?php echo $dia_nacimeinto_nro ?> de <?php echo $mes_nacimiento_letra ?> de <?php echo $anno_nacimiento_nro ?>, en Pregonero, 
				
				estado Táchira de <?php echo $edad ?> años de edad, con cédula de identidad : <?php echo $letra ?> - <?php echo $cedula ?>, 
			
				está inscrito en esta Institución para cursar el
				<?php echo $semestre ?> ° <?php echo $nivel ?> de <?php echo $plan_estudio ?>, 
				
				en el año escola  <?php echo $lapso ?>.
			
				Constancia que se expide a petición de la parte interesada para
				fines legales
				
				y se firma en <?php echo $objeto->localidad ?>, el <?php echo $dia_nro_actual ?> de <?php echo $mes_actual_letra ?> de <?php echo $yy_actual_nro ?>.
			</p>
...
$mPDF->Output("ConstanciaInscrip.pdf",$aux_resplan); 
