	...
	<div id='cuerpo'  style='width:740px; text-align:center;'>
		<div style='width:100%; text-align:center;'>
			...
			<p style='line-height: 2.1;  text-indent: 5em; text-align:justify;' > 
				...
				Estado Táchira de <?php echo $edad ?> años de edad, 
				
				con cédula de identidad <?php echo $letra ?>-<?php echo $cedula ?>, 
				es estudiante del <?php echo $semestre ?>° <?php echo $nivel ?> de <?php echo $plan_estudio ?>, 
			 
				en esta Institución en el período escolar  <?php echo $lapso ?>.
			
				Constancia que se expide a petición de la parte interesada para
				fines legales y se firma en <?php echo $objeto->localidad ?>,
			
				 el <?php echo $dia_nro_actual ?> de <?php echo $mes_actual_letra ?> de <?php echo $yy_actual_nro ?>.
			</p>
...
$mPDF->Output("ConstanciaEstudios.pdf",$aux_resplan); 
